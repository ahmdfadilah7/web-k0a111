...
<head>
    ...
    <title>Pendaftaran Petugas - {{ $setting->nama_website }}</title>
                ...
                <div class="row">
                    <div
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form action="{{ route('proses_register_petugas') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nm_lengkap" class="form-control" id="nm_lengkap" value="{{ old('nm_lengkap') }}">
                                        <i class="text-danger">{{ $errors->first('nm_lengkap') }}</i>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="polres" class="form-control selectric">
                                            <option value="">- Pilih -</option>
                                            @foreach($polres as $row)
                                                <option value="{{ $row->id }}">{{ $row->nama_polres }}</option>
                                            @endforeach
                                        </select>
                                        <i class="text-danger">{{ $errors->first('polres') }}</i>
                                    </div>

                                    <div class="form-group">
                                        <label for="polres">Jabatan</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <input type="password" name="password" class="form-control pwstrength" id="password">
